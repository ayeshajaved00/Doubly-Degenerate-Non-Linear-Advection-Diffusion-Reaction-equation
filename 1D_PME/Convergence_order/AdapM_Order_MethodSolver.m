...
function [h_AdapM_values, average_orders_AdapM] = AdapM_Order_MethodSolver(L, R, n_values, T, dt, ee, m)
    h_AdapM_values = zeros(size(n_values));
