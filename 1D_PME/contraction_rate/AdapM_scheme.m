%% PME - Contraction rate 
% This script solves the PME using iterative 
% scheme (M adaptive scheme) and calculate the contraction rate.
clc;
clear all;
close all;
...
adap_num_values = 295; % Number of values in the range
...
for j = t_start:t_end
    ...
    for i = 1:iteration_no
        ...
        EA = [EA, err];
        no_it_pertimestep = no_it_pertimestep + 1;
