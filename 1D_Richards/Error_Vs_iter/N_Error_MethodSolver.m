function  [N_iter_per_step_values, h_N_values, iteration_N_iter, EA_N] = N_Error_MethodSolver(L, R, n_values, b_values, B_values, T, dt, ee, m)
        ...
        for j = t_start:t_end
            ...
            for i = 1:iteration_no 
                ...
                f = b_n(2:n) - (1 - ee * dt) .* b_iter(2:n) + (1 - ee * dt) .* Lb(2:n) .* S_iter(2:n) + ...
                    ...
                    (dt / dx) * (-(F_iter_prime(1:n - 1) .* S_iter(1:n - 1)) + (F_iter_prime(2:n) .* S_iter(2:n)) + ...
                    (F_iter(1:n - 1) - F_iter(2:n)));
